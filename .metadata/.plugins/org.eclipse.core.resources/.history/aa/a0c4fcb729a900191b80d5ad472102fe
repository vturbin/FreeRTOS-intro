...
void toggle_led_second(void* params);
...
int main(void)
{
	...
	xTaskCreate(led_task_handler, "TOGGLE_LED_200ms", 500, NULL, 1, &xTaskHandle1);
	xTaskCreate(toggle_led_second, "TOGGLE_LED_1000ms", 500, NULL, 2, &xTaskHandle2);
